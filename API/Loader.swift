...
final class Loader {
    ...
    class func getAllFollowersFromServer(withURL url: String, parameter: [String: String], token: HTTPHeaders, completion: @escaping (_ followers: [Follower]?, _ success: Bool?, _ error: Error?) -> ()) {
